...
export default {
    ...
    vehicles: {
        ...
        34: {
            ...
            special: 'Required once you have built 15 Rescue stations. It is required for missions that can spawn with over 20 paitents to help command the scene it dose dual act as a OTL as well',
        },
    },
    buildings: {
        0: {
